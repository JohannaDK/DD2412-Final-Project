...
class TST(nn.Module):
    def __init__(self, dataset="MNIST", latent_dim=128, num_classes=10, separate_body=False, pretrained_qyx = None, accelerator="cpu", paper=None, simple_CNN=False, ViT_experiment=False, ResNet50_experiment = False):
        super().__init__()
        ...
        self.qzx_model = construct_ClassYEncoder(dataset, latent_dim, ResNet50_experiment = ResNet50_experiment)
